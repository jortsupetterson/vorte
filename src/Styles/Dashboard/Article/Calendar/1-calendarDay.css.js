export default css`
  ...
  article#calendar_day #calendarDisplay div span:first-child {
    display: flex;
    flex-direction: column;
    justify-content: flex-start;
    align-items: flex-start;
  ...
  article#calendar_day #calendarDisplay div span:first-child span {
    font-weight: 300;
    border-right: none;
    display: flex;
    justify-content: flex-start;
  ...
  article#calendar_day #calendarDisplay div span:last-child {
    width: 70%;
    font-size: small;
    font-weight: 100;
    text-align: center;
